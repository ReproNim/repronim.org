...
[Video Presentation](https://youtu.be/NWooJ9u2jIo) is now available.
...
We welcome guest speaker [Eugenio Iglesias](https://www.martinos.org/faculty/juan-eugenio-iglesias/) from MGH/HMS and the Martinos Center for Biomedical Imaging, for a presentation on Synth*: Domain Randomization for out-of-the-box Brain Analysis with Enhanced Reproducibility.
...
ReproNim collaborators [Michael O'Shea](https://www.med.unc.edu/pediatrics/people/t-michael-oshea-md-mph/) and the [ELGAN](https://elgan.fpg.unc.edu/) team discuss Neuroimaging Studies of Consequences of Extremely Premature Birth in partnership with our own David Kennedy for related discussion of ReproNim-enabled Diffusion Imaging Analyses
